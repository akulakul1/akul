        ...
        <div className="space-y-6 pb-6 text-base">
          ...
          <div className="pt-4">
            ...
            <div className="flex gap-6 text-2xl">
              <a href="#"><i className="fab fa-facebook-f text-gray-600 hover:text-black" /></a>
              <a href="#"><i className="fab fa-twitter text-gray-600 hover:text-black" /></a>
              <a href="#"><i className="fab fa-instagram text-gray-600 hover:text-black" /></a>
              <a href="#"><i className="fab fa-linkedin-in text-gray-600 hover:text-black" /></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="md:w-1/2 bg-white p-8 rounded-3xl shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-sm">
          <div className="flex gap-4">
            <input name="first" required type="text" placeholder="First" className="w-1/2 border rounded-xl px-4 py-2" />
            <input name="last" required type="text" placeholder="Last" className="w-1/2 border rounded-xl px-4 py-2" />
          </div>
          <input name="email" required type="email" placeholder="Email" className="w-full border rounded-xl px-4 py-2" />
          <input name="subject" required type="text" placeholder="Subject" className="w-full border rounded-xl px-4 py-2" />
          <textarea name="message" required placeholder="Message" rows="5" className="w-full border rounded-xl px-4 py-2" />
          <button type="submit" className="bg-black text-white px-6 py-3 rounded-full hover:bg-gray-900">Send Message</button>
          {formStatus && (
